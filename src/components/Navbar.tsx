...
const Navbar = () => {
  ...
  return (
    <div 
      className="fixed top-0 left-0 right-0 z-50 h-28 md:h-20 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 bg-white dark:bg-secondary-900 border-b border-secondary-200 dark:border-secondary-700 backdrop-blur-sm bg-opacity-95 dark:bg-opacity-95 transition-all duration-300"
      style={{
    ...
    >
      {/* MOBILE (2 Rows, Amazon Style) */}
      <div className="h-full flex flex-col justify-between py-2 md:hidden">
        {/* ROW 1: Branding & Profile/Cart */}
        <div className="flex items-center justify-between w-full h-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/">
              <div 
                className="text-xl tracking-wide font-extrabold text-primary-600 dark:text-primary-400 transition-all duration-200"
                style={{
          ...
          <div className="flex items-center gap-4">
            <Link href="/profile" className="cursor-pointer transform transition-transform duration-200 hover:scale-110">
              <Image 
                src="/profile.png" 
                alt="Profile" 
                width={18} 
            ...
            >
              <Image 
                ...
                className="dark:invert dark:brightness-0 dark:filter transition-all duration-200"
              />
              <div className="absolute -top-2 -right-2 w-4 h-4 bg-sukku rounded-full text-white text-[9px] flex items-center justify-center font-bold">
                {counter}
              </div>
            </div>
          </div>
